...
public class GraphTestDriver {
    ...
    private void listNodes(String graphName) {
        ...
        Set<String> nodeSet = g.allNodes();

        if (nodeSet == null || nodeSet.isEmpty()) {
            output.println(result);
            return;
        }
        // assemble the nodes and sort them
        String[] arr = new String[nodeSet.size()];
        int i = 0;
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        // get outgoing edges
        List<Graph<String, String>.Edge> edgeList = g.outgoingEdgesFrom(parentName);

        if (edgeList == null) {
            output.println(result);
            return;
        }
        // assemble the children nodes and sort them
        String[] arr = new String[edgeList.size()];
        int i = 0;
        for (Graph<String, String>.Edge e : edgeList) {
            arr[i] = e.to() + "(" + e.getEdgeData() + ")";
            i++;
        }
