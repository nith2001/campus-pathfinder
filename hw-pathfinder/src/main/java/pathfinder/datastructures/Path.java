 ...
 */
public class Path<POINT> implements Iterable<Path<POINT>.Segment> {
     ...
     */
    public Path<POINT> extend(POINT newEnd, double segmentCost) {
        checkRep();
        // create new path duplicate
        Path<POINT> extendedPath = new Path<>(start);
    ...
    /**
     * @return the hashcode specific to the Path object
     */
    @Override
    public int hashCode() {
